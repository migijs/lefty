...
describe('classes', function() {
  ...
  it('@link', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}set v1(v){;this.__array("t",v);this.__data("t")}set v2(v){;this.__array("t",v);this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t)},true)]])}}migi.name(A,"A");');
  });
  it('extends from custom', function() {
    var s = 'class A extends X{constructor(){}@bind set t(){}get t(){}render(){return <p>{this.t}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t)},true)]])}}migi.name(A,"A");');
  });
  it('ab.', function() {
...
describe('linkage', function() {
  it('expr', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(v){this.__setBind("t",v);this.__data("t")}get t(){ return this.__getBind("t")}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return((this.t))},true)]])}}migi.name(A,"A");');
  });
  it('expr2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind t @bind d render(){return <p>{(this.t,this.d)}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(v){this.__setBind("t",v);this.__data("t")}get t(){ return this.__getBind("t")} set d(v){this.__setBind("d",v);this.__data("d")}get d(){ return this.__getBind("d")}render(){return migi.createVd(["p",[],[new migi.Obj(["t","d"],()=>{return((this.t,this.d))},true)]])}}migi.name(A,"A");');
  });
  it('expr3', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind t render(){return <p>{(this.t,a)}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(v){this.__setBind("t",v);this.__data("t")}get t(){ return this.__getBind("t")}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return((this.t,a))})]])}}migi.name(A,"A");');
  });
  it('expr4', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind t render(){return <p>{(a,this.t)}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(v){this.__setBind("t",v);this.__data("t")}get t(){ return this.__getBind("t")}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return((a,this.t))},true)]])}}migi.name(A,"A");');
  });
  it('cndtexpr', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{1?this.t:""}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(1?this.t:"")})]])}}migi.name(A,"A");');
  });
  it('mmbexpr', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this.t.a}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t.a)})]])}}migi.name(A,"A");');
  });
  it('mmbexpr []', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this["t"]}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this["t"])})]])}}migi.name(A,"A");');
  });
  it('this[mmbexpr]', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this[this.t]}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this[this.t])})]])}}migi.name(A,"A");');
  });
  it('this[expr]', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this[a,this.t]}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this[a,this.t])})]])}}migi.name(A,"A");');
  });
  it('this.mmbexpr[this.mmbexpr]', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set d(){;this.__data("d")}get d(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj(["d","t"],()=>{return(this.d[this.t])})]])}}migi.name(A,"A");');
  });
  it('[mmbexpr]', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{a[this.t]}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(a[this.t])})]])}}migi.name(A,"A");');
  });
  it('a.b[mmbexpr]', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{a.b[this.t]}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(a.b[this.t])})]])}}migi.name(A,"A");');
  });
  it('[expr]', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{a[b,this.t]}</p>}}';
    var res = lefty.parse(s);
  ...
  it('newexpr', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(new this.t)})]])}}migi.name(A,"A");');
  });
  ...
  it('callexpr', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(fn(this.t))})]])}}migi.name(A,"A");');
  });
  it('addexpr', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this.t+1}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t+1)})]])}}migi.name(A,"A");');
  });
  it('addexpr 2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{0+this.t+1}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(0+this.t+1)})]])}}migi.name(A,"A");');
  });
  it('&&expr', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{a||this.t}</p>}}';
    var res = lefty.parse(s);
  ...
  it('@link', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class Person extends migi.Component{constructor(){}get name(){}set first(v){;this.__array("name",v);this.__data("name")}set last(v){;this.__array("name",v);this.__data("name")}render(){return(migi.createVd(["p",[],[new migi.Obj("name",()=>{return(this.name)},true)]]));}}migi.name(Person,"Person");');
  });
  it('(expr)', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{(this.t)}</p>}}';
    var res = lefty.parse(s);
  ...
  it('model input', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class Input extends migi.Component{constructor(){}render(){return(migi.createVd(["input",[["value",new migi.Obj("model.txt",()=>{return(this.model.txt)},true,(v)=>{v!==this.model.txt&&(this.model.txt=v)})]]]));}}migi.name(Input,"Input");');
  });
  it('rest', function() {
  ...
  it('new expr', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(new B(this.t))})]])}}migi.name(A,"A");');
  });
  it('new expr2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{new B(a,...this.t)}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(new B(a,...this.t))})]])}}migi.name(A,"A");');
  });
  it('new expr3', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{new B(this.t).toString()}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(new B(this.t).toString())})]])}}migi.name(A,"A");');
  });
  it('no recursion', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind set t(){}get t(){}render(){return <p>{this.t?"-":<a>{this.t}</a>}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t?"-":migi.createVd(["a",[],[this.t]]))})]])}}migi.name(A,"A");');
  });
  it('recursion cb', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set t(){;this.__data("t")}get t(){}render(){return migi.createVd(["p",[],[new migi.Obj("t",()=>{return(this.t?"-":migi.createVd(["a",[["onClick",new migi.Cb(this,this.click)]],[this.t]]))})]])}}migi.name(A,"A");');
  });
  it('ab.', function() {
    var s = 'class A extends X{constructor(){}@bind b render(){return <p>{this.b}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj("b",()=>{return(this.b)},true)]])}}migi.name(A,"A");');
  });
  it('ab. 2', function() {
    var s = 'class A extends X{constructor(){}@link(c) b set c(){} render(){return <p>{this.b}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set b(v){this.__setBind("b",v)}get b(){ return this.__getBind("b")}set c(){;this.__data("b")} render(){return migi.createVd(["p",[],[new migi.Obj("b",()=>{return(this.b)},true)]])}}migi.name(A,"A");');
  });
  it('ab. 3', function() {
    var s = 'class A extends X{constructor(){}@link(c) b set c(v){} render(){return <p>{this.b}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set b(v){this.__setBind("b",v)}get b(){ return this.__getBind("b")}set c(v){;this.__array("b",v);this.__data("b")} render(){return migi.createVd(["p",[],[new migi.Obj("b",()=>{return(this.b)},true)]])}}migi.name(A,"A");');
  });
  it('cpeapl 1', function() {
    var s = 'class A extends X{constructor(){}@bind a render(){return <p>{(this.a)}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return((this.a))},true)]])}}migi.name(A,"A");');
  });
  it('cpeapl 2', function() {
    var s = 'class A extends X{constructor(){}@bind a render(){return <p>{(this.a).b}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return((this.a).b)})]])}}migi.name(A,"A");');
  });
  it('cpeapl 3', function() {
    var s = 'class A extends X{constructor(){}@bind a render(){return <p>{(this.a || []).map(function(){})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends X{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return((this.a || []).map(function(){}))})]])}}migi.name(A,"A");');
  });
  it('bind property', function() {
    var s = 'class A extends migi.x{constructor(){}@bind a render(){return <B @c={this.a} d={this.a}/>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.x{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createCp([B,[["c",new migi.Obj("a",()=>{return(this.a )},true)],["d",this.a]]])}}migi.name(A,"A");');
  });
  it('condition expr', function() {
    var s = 'class A extends migi.xxx{constructor(){}get a(){}@bind set a(v){}render(){return <p>{this.a?1:<b>1</b>}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}get a(){} set a(v){;this.__array("a",v);this.__data("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return(this.a?1:migi.createVd(["b",[],["1"]]))})]])}}migi.name(A,"A");');
  });
  it('fnexpr', function() {
  ...
  it('inner fn', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}get a(){} set a(v){;this.__array("a",v);this.__data("a")}render(){return migi.createVd(["p",[],[b.map(function(){return new migi.Obj("a",()=>{return(this.a)})})]])}}migi.name(A,"A");');
  });
  it('jsx', function() {
    var s = 'class A extends migi.xxx{constructor(){}get a(){}@bind a @bind b render(){return <p>{this.a?<b>{this.b?1:2}</b>:3}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}get a(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj(["a","b"],()=>{return(this.a?migi.createVd(["b",[],[this.b?1:2]]):3)})]])}}migi.name(A,"A");');
  });
  it('jsx attr', function() {
    var s = 'class A extends migi.xxx{constructor(){}get a(){}@bind a @bind b render(){return <p>{this.a?<b b={this.b}/>:3}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}get a(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj(["a","b"],()=>{return(this.a?migi.createVd(["b",[["b",this.b]]]):3)})]])}}migi.name(A,"A");');
  });
  it('jsx combo', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){}get a(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj(["b","a"],()=>{return(1?migi.createVd(["b",[],[this.b?1:2]]):migi.createVd(["i",[["p",this.a]]]))})]])}}migi.name(A,"A");');
  });
  it('bind inner', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.x{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return(true?migi.createVd(["input",[["value",new migi.Obj("a",()=>{return(this.a)},false,(v)=>{v!==this.a&&(this.a=v)})]]]):migi.createVd(["input",[["value",this.b]]]))})]])}}migi.name(A,"A");');
  });
  it('bind inner 2', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.x{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return(true?migi.createVd(["select",[["value",new migi.Obj("a",()=>{return(this.a)},false,(v)=>{v!==this.a&&(this.a=v)})]]]):migi.createVd(["select",[["value",2]]]))})]])}}migi.name(A,"A");');
  });
  it('bind inner 3', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return(true ? migi.createVd(["textarea",[],[new migi.Obj("a",()=>{return(this.a)},false,(v)=>{v!==this.a&&(this.a=v)})]]):1)})]]);}}migi.name(A,"A");');
  });
  it('template', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{`${this.a}`}</p>;}}';
    var res = lefty.parse(s);
  ...
  it('textarea', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["textarea",[],[new migi.Obj("a",()=>{return(this.a)},true,(v)=>{v!==this.a&&(this.a=v)})]])}}migi.name(A,"A");');
  });
  it('textarea 2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <textarea>{this.a + 1}</textarea>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["textarea",[],[new migi.Obj("a",()=>{return(this.a + 1)})]])}}migi.name(A,"A");');
  });
  it('text', function() {
  ...
  it('input', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["input",[["value",new migi.Obj("a",()=>{return(b[this.a])},false,(v)=>{v!==b[this.a]&&(b[this.a]=v)})]]])}}migi.name(A,"A");');
  });
  it('input 2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <input value={this.a+1}/>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["input",[["value",new migi.Obj("a",()=>{return(this.a+1)})]]])}}migi.name(A,"A");');
  });
  it('input 3', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <input checked={this.a}/>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["input",[["checked",new migi.Obj("a",()=>{return(this.a)},true,(v)=>{v!==this.a&&(this.a=v)})]]])}}migi.name(A,"A");');
  });
  it('option', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <option selected={this.a}/>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["option",[["selected",new migi.Obj("a",()=>{return(this.a)},true,(v)=>{v!==this.a&&(this.a=v)})]]])}}migi.name(A,"A");');
  });
});
...
describe('arrowfn', function() {
  it('exprstmt', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{this.a}))})]])}}migi.name(A,"A");');
  });
  it('varstmt', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{var a=this.a})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{var a=this.a}))})]])}}migi.name(A,"A");');
  });
  ...
  it('ifstmt', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{if(this.a){}}))})]])}}migi.name(A,"A");');
  });
  it('ifstmt2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{if(1){this.a}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{if(1){this.a}}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt for', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{for(let a=this.a;;){}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{for(let a=this.a;;){}}))})]])}}migi.name(A,"A");');
  });
  ...
  it('iterstmt for3', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{for(;;this.a){}}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt for var', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{for(var a=this.a;;){}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{for(var a=this.a;;){}}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt do', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{do{}while(this.a)})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{do{}while(this.a)}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt do2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{do{this.a}while(1)})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{do{this.a}while(1)}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt while', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{while(this.a){}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{while(this.a){}}))})]])}}migi.name(A,"A");');
  });
  it('iterstmt while2', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{while(1){this.a}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{while(1){this.a}}))})]])}}migi.name(A,"A");');
  });
  it('retstmt', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{return this.a})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[[].map(()=>{return new migi.Obj("a",()=>{return(this.a)})})]])}}migi.name(A,"A");');
  });
  it('withstmt', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{with(this.a){}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{with(this.a){}}))})]])}}migi.name(A,"A");');
  });
  it('swtchstmt', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{switch(this.a){}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{switch(this.a){}}))})]])}}migi.name(A,"A");');
  });
  it('swtchstmt case', function() {
    var s = 'class A extends migi.xxx{constructor(){}@bind a render(){return <p>{[].map(()=>{switch(1){case this.a:1}})}</p>}}';
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{switch(1){case this.a:1}}))})]])}}migi.name(A,"A");');
  });
  it('swtchstmt case expr', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{switch(1){case 1:this.a}}))})]])}}migi.name(A,"A");');
  });
  it('swtchstmt default', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map(()=>{switch(1){case 1:1;default:this.a}}))})]])}}migi.name(A,"A");');
  });
  it('bind only in return', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[[].map((item)=>{return new migi.Obj(["a","b"],()=>{return(this.a+this.b)})})]])}}migi.name(A,"A");');
  });
  it('bind not only in return', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map((item)=>{this.a;return new migi.Obj("b",()=>{return(this.b)})}))})]])}}migi.name(A,"A");');
  });
  it('bind not only in return 2', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")} set b(v){this.__setBind("b",v);this.__data("b")}get b(){ return this.__getBind("b")}render(){return migi.createVd(["p",[],[new migi.Obj("b",()=>{return(this.b.map((item)=>{return new migi.Obj("a",()=>{return(this.a)})}))})]])}}migi.name(A,"A");');
  });
  it('in arrowfn', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[new migi.Obj("a",()=>{return([].map((item)=>{[].map((item2)=>{this.a});return 1}))})]])}}migi.name(A,"A");');
  });
  it('in arrowfn 2', function() {
    ...
    var res = lefty.parse(s);
    expect(res).to.eql('class A extends migi.xxx{constructor(){} set a(v){this.__setBind("a",v);this.__data("a")}get a(){ return this.__getBind("a")}render(){return migi.createVd(["p",[],[[].map((item)=>{return [].map((item2)=>{return new migi.Obj("a",()=>{return(this.a)})})})]])}}migi.name(A,"A");');
  });
